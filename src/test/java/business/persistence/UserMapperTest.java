...
public class UserMapperTest {
    ...
    public void setUp() {
        ...
        try (Statement stmt = database.connect().createStatement()) {
            ...
            stmt.execute(
                    "INSERT INTO `cupcake_shop_test`.`users` (" +
                            "`email`," +
                            "`password`," +
                            "`role`," +
                            "`phone_number`," +
                            "`name`) VALUES" +
                            "('jens@somewhere.com','jensen','customer', '12345678', 'Jens'), " +
                            "('ken@somewhere.com','kensen','customer', '12345679', 'Ken'), " +
                            "('robin@somewhere.com','batman','employee', '12345671', 'Robin')");
    ...
    public void testCreateUser01() throws UserException {
        ...
        User original = new User("king@kong.com", "uhahvorhemmeligt", "konge", "82931032", "Jens Paulsen");
